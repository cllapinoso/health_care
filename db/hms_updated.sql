...
CREATE TABLE `medical_checkup_lab_form` (
  ...
  `infectiousDiseaseScreening` text DEFAULT NULL,
...
INSERT INTO `medical_checkup_lab_form` (`id`, `labName`, `address`, `phone`, `date`, `patientId`, `fullName`, `dob`, `age`, `gender`, `contactNumber`, `email`, `patientAddress`, `referredBy`, `familyPhysician`, `emergencyContact`, `relationship`, `emergencyPhone`, `chronicConditions`, `previousSurgeries`, `allergies`, `currentMedications`, `familyMedicalHistory`, `bloodPressure`, `heartRate`, `respiratoryRate`, `temperature`, `height`, `weight`, `bmi`, `bloodTests`, `urineTests`, `imagingTests`, `infectiousDiseaseScreening`, `otherTests`, `physicianNotes`, `created_at`) VALUES
(1, 'hreter', '', NULL, NULL, NULL, 'erh', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2025-04-24 07:27:38');
