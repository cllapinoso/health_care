...
if (strlen($_SESSION['id']) == 0) {
    ...
    if (isset($_POST['submit'])) {   
        ...
        if ($sql) {
            ...
            $sql_queue = mysqli_query($con, "INSERT INTO patient_ques(lastname, firstname, middlename, queue_number, queue_date, status, service, room, priority, priority_text) VALUES('$patlastname', '$patfirstname', '$patmiddlename', '$queue_number', '$queue_date', '$status', '$service', '$room_number', '$priority', '$priorityOption')");
