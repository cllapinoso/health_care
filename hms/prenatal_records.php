...
<html lang="en">
<head>
    <title>View Prenatal Records</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle"><strong>Prenatal Records</strong></h1>
                            </div>
                            <ol class="breadcrumb">
                                <li></li>
                                <li class="active">
                                    <span>View Prenatal Records</span>
                                </li>
                            </ol>
                        </div>
                    </section>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <table class="table table-hover" id="sample-table-1">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = mysqli_query($con, "SELECT * FROM prenatal_lab_form WHERE fullName='$fullName'");
                                        $cnt = 1;
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="detailsModalLabel">Prenatal Form Details</h4>
                </div>
                <div class="modal-body">
                    <div class="loading-container">
                        <i class="fa fa-spinner fa-spin fa-3x loading-spinner"></i>
                        <p>Loading Prenatal form details...</p>
                    </div>
                    <div id="details-content" class="hidden">
                        ...
                        <div class="info-card">
                            ...
                            <div class="field-row">
                                <div class="field-label">OBGYN Name:</div>
                                <div class="field-value" id="detail-obgynName"></div>
                            </div>
                            <div class="field-row">
                                <div class="field-label">OBGYN Contact:</div>
                                <div class="field-value" id="detail-obgynContact"></div>
                            </div>
                            <div class="field-row">
                                <div class="field-label">Last Menstrual Period (LMP):</div>
                                <div class="field-value" id="detail-lmp"></div>
                            </div>
                            <div class="field-row">
                                <div class="field-label">Estimated Due Date (EDD):</div>
                                <div class="field-value" id="detail-edd"></div>
                            </div>
                            <div class="field-row">
                                <div class="field-label">Gravida:</div>
                                <div class="field-value" id="detail-gravida"></div>
                            </div>
                            <div class="field-row">
                                <div class="field-label">Para:</div>
                                <div class="field-value" id="detail-para"></div>
                            </div>
                            <div class="field-row">
                            ...
                            <div class="field-row">
                                <div class="field-label">Previous Complications:</div>
                                <div class="field-value" id="detail-previousComplications"></div>
                            </div>
                            <div class="field-row">
                            ...
                            <div class="field-row">
                                <div class="field-label">Ultrasound:</div>
                                <div class="field-value" id="detail-ultrasound"></div>
                            </div>
                            <div class="field-row">
                                <div class="field-label">Notes:</div>
                                <div class="field-value" id="detail-notes"></div>
                            </div>
                            <div class="field-row">
            ...
            $('.view-details').on('click', function() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        // Additional Information
                        $('#detail-obgynName').html(displayValue(response.obgynName));
                        $('#detail-obgynContact').html(displayValue(response.obgynContact));
                        $('#detail-lmp').html(displayValue(response.lmp));
                        $('#detail-edd').html(displayValue(response.edd));
                        $('#detail-gravida').html(displayValue(response.gravida));
                        $('#detail-para').html(displayValue(response.para));
                        $('#detail-previousPregnancies').html(displayValue(response.previousPregnancies));
                        $('#detail-previousComplications').html(displayValue(response.previousComplications));
                        ...
                        $('#detail-ultrasound').html(displayValue(response.ultrasound));
                        $('#detail-notes').html(displayValue(response.notes));
