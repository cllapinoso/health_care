...
<html lang="en">
<head>
    <title>View HIV Test Records</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle"><strong>HIV Test Records</strong></h1>
                            </div>
                            <ol class="breadcrumb">
                                <li></li>
                                <li class="active">
                                    <span>View HIV Test Records</span>
                                </li>
                            </ol>
                        </div>
                    </section>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <table class="table table-hover" id="sample-table-1">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = mysqli_query($con, "SELECT * FROM hiv_lab_form WHERE fullName='$fullName'");
                                        $cnt = 1;
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="detailsModalLabel">HIV Form Details</h4>
                </div>
                <div class="modal-body">
                    <div class="loading-container">
                        <i class="fa fa-spinner fa-spin fa-3x loading-spinner"></i>
                        <p>Loading HIV form details...</p>
                    </div>
                    <div id="details-content" class="hidden">
                        ...
                        <div class="info-card">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="field-row">
                                        <div class="field-label">Family Physician:</div>
                                        <div class="field-value" id="detail-familyPhysician"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="info-card">
                            ...
                            <div class="field-row">
                                <div class="field-label">Tested Before:</div>
                                <div class="field-value" id="detail-testedBefore"></div>
                            </div>
                            <div class="field-row">
                                <div class="field-label">Tested When:</div>
                                <div class="field-value" id="detail-testedWhen"></div>
                            </div>
                            <div class="field-row">
                                <div class="field-label">Risk Factors:</div>
                                <div class="field-value" id="detail-riskFactors"></div>
                            </div>
                            <div class="field-row">
                                <div class="field-label">Symptoms:</div>
                                <div class="field-value" id="detail-symptoms"></div>
                            </div>
                            <div class="field-row">
                                <div class="field-label">Testing Options:</div>
                                <div class="field-value" id="detail-testingOptions"></div>
                            </div>
                            <div class="field-row">
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            $('.view-details').on('click', function() {
                ...
                $.ajax({
                    url: 'get_hiv_lab_details.php', // Updated to use the correct script
                    type: 'POST',
                    data: {id: recordId},
                    dataType: 'json',
                    success: function(response) {
                        ...
                        $('#detail-familyPhysician').html(displayValue(response.familyPhysician));
                        
                        // Additional Information
                        $('#detail-testedBefore').html(displayValue(response.testedBefore));
                        $('#detail-testedWhen').html(displayValue(response.testedWhen));
                        $('#detail-riskFactors').html(displayValue(response.riskFactors));
                        $('#detail-symptoms').html(displayValue(response.symptoms));
                        $('#detail-testingOptions').html(displayValue(response.testingOptions));
