...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
    ...
    $stmt = $con->prepare("SELECT id, lastname, middlename, firstname, queue_number, status, service, room, priority, priority_text FROM patient_ques WHERE queue_date = ? AND status IN ('Waiting', 'Consulting') ORDER BY priority DESC, queue_number");
